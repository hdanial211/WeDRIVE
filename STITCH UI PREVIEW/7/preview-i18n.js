...
const PREVIEW_I18N = {
    ms: {
        ...
        field_brand_select: "Pilih Pengeluar",
        field_model: "Model",
        field_model_ph: "Cth: Civic",
        field_variant: "Varian",
        field_variant_ph: "Cth: 1.5 TC-P",
        field_plate: "No. Pendaftaran",
        field_year: "Tahun Dibuat",
        field_color: "Warna Kenderaan",
        field_color_ph: "Cth: Meteoroid Gray Metallic",
        ...
        field_category_select: "Pilih Kategori",
        field_fuel: "Punca Kuasa (Bahan Api)",
        field_fuel_select: "Pilih Punca Kuasa",
        field_transmission: "Sistem Transmisi",
        field_transmission_select: "Pilih Transmisi",
        field_seats: "Kapasiti Tempat Duduk",
        field_seats_select: "Pilih Tempat Duduk",
        ...
        field_engine_ph: "Cth: 1.5L 4-Silinder VTEC Turbo (182 PS / 240 Nm)",
        ...
        step2_sec_cdn_title: "Pusat Pengurusan Aset Media & CDN",
        step2_sec_cdn_desc: "Pautkan URL CDN rasmi kenderaan untuk jana paparan 360° serta-merta.",
        cdn_input_label: "URL CDN / Pelayan Visual Kenderaan",
        ...
        toast_cdn_scanning: "Sedang mengimbas aset CDN kenderaan...",

        // Step 3: Semakan & Pengesahan Rasmi
        step3_cdn_connected: "CDN Bersambung",
        ...
        index_badge_flow: "Gabungan 3 Skrin Pilihan Anda (Langkah 1 → Langkah 2 → Langkah 3)",
        index_hero_title: "Master Finishing Studio UI WeDRIVE",
        index_hero_desc: "Menggabungkan 100% skrin pilihan anda dari Stitch: Langkah 1 (Civic & Harga), Langkah 2 (Studio Visual & 360), dan Langkah 3 (Semakan Akhir) dengan kawalan dwitema (☀️ Siang / 🌙 Malam) dan fizik sentuhan Apple.",
        index_btn_launch_wizard: "Mulakan Aliran Wizard Lengkap (Langkah 1 → 2 → 3)",
        ...
        index_step2_card_desc: "Pengurusan imej pemeriksaan galeri, pengimbasan aset CDN kenderaan, dan pemain visual interaktif 360 darjah.",
    ...
    en: {
        ...
        field_brand_select: "Select Manufacturer",
        field_model: "Model",
        field_model_ph: "E.g. Civic",
        field_variant: "Variant",
        field_variant_ph: "E.g. 1.5 TC-P",
        field_plate: "Plate No.",
        field_year: "Year Made",
        field_color: "Vehicle Color",
        field_color_ph: "E.g. Meteoroid Gray Metallic",
        ...
        field_category_select: "Select Category",
        field_fuel: "Power Source (Fuel)",
        field_fuel_select: "Select Power Source",
        field_transmission: "Transmission System",
        field_transmission_select: "Select Transmission",
        field_seats: "Seating Capacity",
        field_seats_select: "Select Seats",
        seats_2: "2 Seats",
        seats_4: "4 Seats",
        seats_5: "5 Seats",
        seats_7: "7 Seats",
        ...
        field_engine_ph: "E.g. 1.5L 4-Cylinder VTEC Turbo (182 PS / 240 Nm)",
        ...
        step2_sec_cdn_title: "Media Asset & CDN Management Center",
        step2_sec_cdn_desc: "Link official vehicle CDN URL to generate 360° views instantly.",
        cdn_input_label: "Vehicle Visual / CDN Server URL",
        ...
        toast_cdn_scanning: "Scanning vehicle CDN assets...",

        // Step 3: Official Confirmation & Review
        step3_cdn_connected: "CDN Connected",
        ...
        index_badge_hig: "100% APPLE HIG & DUAL THEME",
        index_badge_flow: "3 Screen Combination (Step 1 → Step 2 → Step 3)",
        index_hero_title: "WeDRIVE Master Finishing Studio UI",
        index_hero_desc: "Combining 100% of your Stitch chosen screens: Step 1 (Civic & Pricing), Step 2 (Visual Studio & 360), and Step 3 (Final Review) with dual-theme control (☀️ Day / 🌙 Night) and Apple tactile physics.",
        index_btn_launch_wizard: "Start Full Wizard Flow (Step 1 → 2 → 3)",
        ...
        index_step2_card_desc: "Management of inspection gallery photos, vehicle CDN asset scanning, and 360-degree interactive visual player.",
