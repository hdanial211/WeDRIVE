...
|   +-- rules/                  # Peraturan Pembangunan Bernombor (01–24, Strict Max 12k chars)
...
|   |   +-- 12_max_content_limit.md        # Had Siling 12,000 Aksara, Pengesahan wc -m & Modular Rules
|   |   +-- 13_prd_standard.md             # Piawaian PRD 6 Pilar Mandatori Sebelum Pengekodan
...
|           +-- agents/         # Skuad 6 Subagent Khas WeDRIVE:
...
|               +-- tester.md                 # Penguji Kualiti UI Black-Box Bebas (Pure UI & Realistic CRUD)
|
