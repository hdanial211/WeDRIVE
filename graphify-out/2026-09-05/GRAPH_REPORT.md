...
## Corpus Check
- 99 files · ~20,834,983 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2660 nodes · 5151 edges · 183 communities (113 shown, 70 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 286 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cd202b6f`
...
Cohesion: 0.02
Nodes (23): bs(), getAverageFrequency(), getFrequencyData(), Gr(), hl, _initMemoryManager(), jr(), kr() (+15 more)
...
### Community 15 - "clone"
Cohesion: 0.09
Nodes (14): A(), clone(), _i, mr, rr, Ua(), b(), S() (+6 more)
...
Cohesion: 0.11
Nodes (5): add(), at(), setDirection(), setFromCamera(), setFromCenterAndSize()
...
Cohesion: 0.14
Nodes (20): m(), t(), constructor(), a(), ji(), o(), me(), c() (+12 more)
...
Cohesion: 0.10
Nodes (10): bindSkeletons(), _c, Ml, parseAnimations(), parseAsync(), parseGeometries(), parseObject(), parseShapes() (+2 more)
...
Cohesion: 0.10
Nodes (9): T(), ei, S(), Tu(), Bt(), Gt(), kt(), n() (+1 more)
...
### Community 54 - ".dot"
Cohesion: 0.13
Nodes (4): al(), closestPointToPoint(), closestPointToPointParameter(), fn
...
### Community 58 - ".fromBufferAttribute"
Cohesion: 0.22
Nodes (3): setColors(), setXY(), setXYZ()
...
Cohesion: 0.10
Nodes (15): de(), dispose(), Hr(), i(), qr(), C(), i(), Vr() (+7 more)
...
Cohesion: 0.07
Nodes (5): applyMatrix4(), li, translate(), vo, Xi
...
### Community 175 - "i"
Cohesion: 0.11
Nodes (16): dh, i(), hh, load(), a(), c(), loadAsync(), parse() (+8 more)

## Knowledge Gaps
- **328 isolated node(s):** `allBookings`, `allCars`, `CAL_DATA`, `CAL_FILTERS`, `allBookings` (+323 more)
...
- **Why does `gn` connect `gn` to `three.min.js`, `.fromArray`, `constructor`, `updateMatrixWorld`, `.fromJSON`, `.constructor`, `toJSON`, `.constructor`, `he`, `.multiplyScalar`, `applyMatrix4`, `.updateMatrix`, `.length`, `remove`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `copy()` connect `copy` to `three.min.js`, `ve`, `Be`, `bl`, `ll`, `ai`, `s`, `dc`, `clone`, `he`, `.setValues`, `bc`, `.multiplyScalar`, `cl`, `tr`, `.updateMatrix`, `mc`, `.fromArray`, `Rl`, `ah`, `constructor`, `wl`, `updateMatrixWorld`, `.fromJSON`, `gi`, `on`, `toJSON`, `.constructor`, `Il`, `ul`, `.constructor`, `Nl`, `wc`, `.dot`, `.setAttribute`, `vl`, `dispose`, `fa`, `sh`, `lr`, `ph`, `.toArray`, `.setHSL`, `El`, `Qn`, `sl`, `ie`, `da`, `ec`, `fh`, `Ro`, `applyMatrix4`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `en()` connect `anime.min.js` to `.fromArray`, `i`?**
