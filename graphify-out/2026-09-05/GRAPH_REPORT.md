...
## Corpus Check
- 98 files · ~20,829,512 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2651 nodes · 5143 edges · 159 communities (108 shown, 51 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 286 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cbc43ef9`
...
3. `ze` - 76 edges
4. `ai` - 64 edges
5. `🚗 WeDRIVE: Ringkasan Penuh Pembangunan Sistem (FYP 1 hingga FYP 2)` - 61 edges
6. `ce` - 57 edges
7. `Ue` - 51 edges
8. `Be` - 38 edges
9. `ve()` - 37 edges
...
### Community 15 - "clone"
Cohesion: 0.09
Nodes (15): T(), clone(), constructor(), fo(), _i, a(), rr, Tu() (+7 more)

### Community 16 - ".setStyle"
Cohesion: 0.19
Nodes (3): ee(), ne(), si()
...
### Community 37 - "i"
Cohesion: 0.14
Nodes (27): m(), v(), t(), a(), i(), ji(), a(), c() (+19 more)
...
### Community 39 - "lr"
Cohesion: 0.09
Nodes (4): distanceToPoint(), lr, ur, Yt()
...
### Community 61 - "yr"
Cohesion: 0.14
Nodes (13): dispose(), Hr(), i(), jr(), h(), qr(), C(), i() (+5 more)
...
### Community 94 - "copy"
Cohesion: 0.07
Nodes (9): bc, copy(), ec(), ih, ka(), i(), Nl, qi (+1 more)
...
### Community 179 - ".subVectors"
Cohesion: 0.11
Nodes (8): getCenter(), getSize(), isEmpty(), nn(), nr, setLength(), updateMatrixWorld(), wc

## Knowledge Gaps
- **320 isolated node(s):** `allBookings`, `allCars`, `CAL_DATA`, `CAL_FILTERS`, `allBookings` (+315 more)
...
- **Why does `gn` connect `gn` to `three.min.js`, `.invert`, `i`, `ze`, `.fromJSON`, `remove`, `toJSON`, `.subVectors`, `.constructor`, `he`, `.dot`, `.multiplyScalar`, `.constructor`, `.updateMatrix`, `.fromArray`, `copy`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `copy()` connect `copy` to `three.min.js`, `.toArray`, `ve`, `Be`, `ai`, `kc`, `dc`, `clone`, `.setStyle`, `he`, `.setValues`, `.raycast`, `.multiplyScalar`, `tr`, `.updateMatrix`, `.constructor`, `.setIndex`, `ll`, `Ml`, `i`, `lr`, `.fromJSON`, `gi`, `on`, `toJSON`, `da`, `fa`, `.subVectors`, `.dot`, `.constructor`, `yr`, `.invert`, `vo`, `vl`, `Qn`, `Uo`, `ie`, `.setAttribute`, `Ro`, `.fromArray`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `en()` connect `anime.min.js` to `.subVectors`, `i`?**
