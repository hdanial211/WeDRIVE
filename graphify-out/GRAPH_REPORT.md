...
## Corpus Check
- 99 files · ~20,834,760 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2659 nodes · 5150 edges · 173 communities (112 shown, 61 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 286 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b186588d`
...
2. `gn` - 78 edges
3. `ze` - 76 edges
4. `🚗 WeDRIVE: Ringkasan Penuh Pembangunan Sistem (FYP 1 hingga FYP 2)` - 67 edges
5. `ai` - 64 edges
6. `ce` - 57 edges
7. `Ue` - 51 edges
8. `Be` - 38 edges
...
Cohesion: 0.03
Nodes (18): Co, fu(), getAverageFrequency(), getFrequencyData(), gu(), hl, intersectObject(), intersectObjects() (+10 more)
...
Cohesion: 0.10
Nodes (6): add(), T(), v(), s(), setFromCamera(), setFromCenterAndSize()
...
### Community 37 - "e"
Cohesion: 0.18
Nodes (20): m(), bs(), a(), ji(), lh, o(), c(), l() (+12 more)
...
### Community 46 - "n"
Cohesion: 0.19
Nodes (19): as(), cs(), ds(), Gr(), gs(), hs(), Is(), ks() (+11 more)
...
Cohesion: 0.08
Nodes (9): ei, fe(), ge(), Vh, xa(), Ft(), kt(), n() (+1 more)
...
### Community 61 - "update"
Cohesion: 0.09
Nodes (19): de(), dispose(), i(), kr(), x(), C(), rr, setFromObject() (+11 more)
...
### Community 69 - "xr"
Cohesion: 0.25
Nodes (5): getParameter(), Sr(), xr(), u(), y()

### Community 70 - "constructor"
Cohesion: 0.10
Nodes (11): br(), c(), constructor(), _i, _initMemoryManager(), setColors(), setDirection(), setLength() (+3 more)
...
Cohesion: 0.07
Nodes (7): al(), applyMatrix4(), closestPointToPoint(), translate(), vo, Yt(), Xi
...
### Community 166 - "na"
Cohesion: 0.17
Nodes (20): B(), G(), H(), O(), z(), na(), D(), et() (+12 more)
...
Cohesion: 0.13
Nodes (8): A(), L(), ha(), va, E(), L(), w(), Za

### Community 175 - "i"
Cohesion: 0.18
Nodes (7): i(), hh, load(), a(), c(), loadAsync(), me()

## Knowledge Gaps
- **327 isolated node(s):** `allBookings`, `allCars`, `CAL_DATA`, `CAL_FILTERS`, `allBookings` (+322 more)
...
- **Why does `gn` connect `gn` to `three.min.js`, `.applyQuaternion`, `e`, `.invert`, `.fromJSON`, `.constructor`, `.dot`, `clone`, `toJSON`, `.constructor`, `he`, `copy`, `.multiplyScalar`, `updateMatrixWorld`, `.updateMatrix`, `applyMatrix4`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `copy()` connect `copy` to `three.min.js`, `ve`, `Be`, `mh`, `ai`, `kc`, `dc`, `Oh`, `clone`, `.setValues`, `bc`, `.multiplyScalar`, `cl`, `tr`, `.updateMatrix`, `dr`, `mc`, `Uo`, `ll`, `e`, `wl`, `.invert`, `.fromJSON`, `gi`, `on`, `toJSON`, `.constructor`, `da`, `.constructor`, `.setAttribute`, `fn`, `.addGroup`, `vl`, `update`, `fa`, `lr`, `ph`, `constructor`, `.setHSL`, `El`, `.dot`, `ie`, `tl`, `updateMatrixWorld`, `.setIndex`, `fh`, `Ro`, `Ml`, `applyMatrix4`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `en()` connect `anime.min.js` to `e`, `.dot`?**
