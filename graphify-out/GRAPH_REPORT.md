...
## Corpus Check
- 142 files · ~21,175,551 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3157 nodes · 5717 edges · 216 communities (149 shown, 67 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 296 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `11e9570f`
...
## Communities (216 total, 67 thin omitted)
...
### Community 16 - "clone"
Cohesion: 0.09
Nodes (14): T(), clone(), jr(), mr, y(), qr(), rr, Ua() (+6 more)
...
### Community 23 - "i"
Cohesion: 0.12
Nodes (35): m(), v(), t(), a(), r(), ea(), i(), ji() (+27 more)
...
Cohesion: 0.08
Nodes (17): de(), dispose(), getParameter(), Hr(), i(), x(), C(), Sr() (+9 more)
...
Cohesion: 0.38
Nodes (14): expand360Tabs(), getLang(), init(), isViewportFullscreen(), navigateGallery(), populateAiInspectionPhotos(), renderGalleryThumbnails(), saveCarVisuals() (+6 more)
...
### Community 71 - ".subVectors"
Cohesion: 0.16
Nodes (5): al(), closestPointToPoint(), closestPointToPointParameter(), delta(), nn()
...
Cohesion: 0.11
Nodes (6): fo(), ka(), i(), nr, qi, updateMatrixWorld()
...
### Community 119 - "copy"
Cohesion: 0.07
Nodes (7): copy(), ec(), ih, Il, Nl, ra(), wc
...
Cohesion: 0.13
Nodes (5): add(), getCenter(), setDirection(), setFromCamera(), setFromCenterAndSize()
...
Cohesion: 0.49
Nodes (9): closeModal(), confirmPublish(), getLang(), init(), loadCarDraft(), navigateStep3Gallery(), renderStep3GalleryThumbnails(), selectStep3GalleryPhoto() (+1 more)
...
## Knowledge Gaps
- **620 isolated node(s):** `PREVIEW_I18N`, `allCars`, `allBookings`, `allCars`, `CAL_DATA` (+615 more)
...
- **Why does `copy()` connect `copy` to `three.min.js`, `Be`, `ve`, `ai`, `.fromJSON`, `dc`, `.toArray`, `clone`, `dr`, `sl`, `he`, `i`, `tr`, `.constructor`, `cl`, `lr`, `fn`, `dispose`, `.raycast`, `Uo`, `vl`, `gi`, `.constructor`, `ie`, `da`, `.multiplyScalar`, `.setValues`, `constructor`, `ll`, `bc`, `equals`, `.invert`, `.fromArray`, `.updateMatrix`, `.setHSL`, `.setStyle`, `toJSON`, `s`, `.constructor`, `kc`, `Za`, `updateMatrixWorld`, `on`, `vo`, `fa`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `ai` connect `ai` to `three.min.js`, `.setHSL`, `.setStyle`, `.constructor`, `.toArray`, `clone`, `.multiplyScalar`, `i`, `updateMatrixWorld`, `applyMatrix4`, `constructor`, `on`, `.fromBufferAttribute`, `vo`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `ze` connect `ze` to `three.min.js`, `Be`, `ve`, `.fromArray`, `.subVectors`, `oe`, `.multiplyScalar`, `.fromBufferAttribute`, `getX`, `.length`, `copy`, `constructor`, `on`, `updateMatrixWorld`, `.constructor`, `applyMatrix4`?**
