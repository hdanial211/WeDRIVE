...
## Corpus Check
- 143 files · ~21,187,238 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3191 nodes · 5773 edges · 225 communities (149 shown, 76 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 294 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0a9cb404`
...
## Communities (225 total, 76 thin omitted)

### Community 0 - "three.min.js"
Cohesion: 0.02
Nodes (22): bs(), Co, getAverageFrequency(), getFrequencyData(), Gr(), _initMemoryManager(), kr(), lh (+14 more)
...
### Community 16 - "clone"
Cohesion: 0.11
Nodes (10): T(), clone(), mr, rr, Ua(), b(), S(), T() (+2 more)
...
Cohesion: 0.08
Nodes (12): ei, fe(), ge(), setUsage(), Vh, Bt(), Ft(), Gt() (+4 more)

### Community 23 - "constructor"
Cohesion: 0.12
Nodes (20): m(), v(), constructor(), me(), s(), c(), h(), l() (+12 more)
...
### Community 31 - "copy"
Cohesion: 0.09
Nodes (8): copy(), fo(), ih, ka(), i(), mo, qi, ra()

### Community 33 - "dispose"
Cohesion: 0.14
Nodes (9): de(), dispose(), Hr(), i(), jr(), qr(), C(), i() (+1 more)
...
### Community 42 - "gi"
Cohesion: 0.07
Nodes (9): gi, oe(), setW(), setX(), setXY(), setXYZW(), setY(), setZ() (+1 more)
...
Cohesion: 0.11
Nodes (6): add(), closestPointToPoint(), closestPointToPointParameter(), delta(), setDirection(), setFromCenterAndSize()
...
### Community 61 - "n"
Cohesion: 0.14
Nodes (13): a(), r(), ea(), ji(), c(), o(), r(), n() (+5 more)

### Community 62 - "step2-studio360.js"
Cohesion: 0.27
Nodes (16): expand360Capabilities(), getLang(), handleGenerateAi(), handleSaveVisuals(), hideAllViewerLayers(), navigateGallery(), renderGalleryThumbnails(), renderPhotoUploadSlots() (+8 more)
...
### Community 84 - "i"
Cohesion: 0.10
Nodes (18): bindSkeletons(), _c, i(), hh, load(), a(), loadAsync(), parse() (+10 more)
...
Cohesion: 0.08
Nodes (10): expandByPoint(), expandByScalar(), getCenter(), getSize(), intersect(), isEmpty(), makeEmpty(), nn() (+2 more)
...
### Community 119 - "s"
Cohesion: 0.17
Nodes (12): s(), B(), F(), G(), H(), L(), O(), z() (+4 more)
...
Cohesion: 0.11
Nodes (7): al(), applyMatrix4(), br(), c(), setFromCamera(), Yt(), Xi
...
Cohesion: 0.41
Nodes (10): closeModal(), confirmPublish(), getLang(), init(), loadCarDraft(), navigateStep3Gallery(), renderStep3GalleryThumbnails(), selectStep3GalleryPhoto() (+2 more)
...
### Community 194 - ".updateWorldMatrix"
Cohesion: 0.12
Nodes (3): Ch, gh, n()

### Community 196 - "setValue"
Cohesion: 0.22
...
Cohesion: 0.83
Nodes (3): getLang(), hydrateCustomerCard(), init()
...
## Knowledge Gaps
- **626 isolated node(s):** `PREVIEW_I18N`, `allCars`, `allBookings`, `allCars`, `CAL_DATA` (+621 more)
...
- **Why does `copy()` connect `copy` to `three.min.js`, `Be`, `ve`, `ai`, `Ml`, `dc`, `dr`, `clone`, `wl`, `sl`, `he`, `.constructor`, `constructor`, `tr`, `na`, `cl`, `equals`, `dispose`, `applyMatrix4`, `vl`, `.fromArray`, `gi`, `.constructor`, `ie`, `da`, `.multiplyScalar`, `.setValues`, `ul`, `updateMatrixWorld`, `Rl`, `.computeFrenetFrames`, `.updateWorldMatrix`, `Ro`, `ll`, `Uo`, `ah`, `fn`, `ph`, `toJSON`, `El`, `.constructor`, `tl`, `kc`, `i`, `Ga`, `lr`, `Oh`, `.subVectors`, `Uh`, `bc`, `ec`, `Il`, `vo`, `Nl`, `wc`, `Za`, `fa`, `s`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `ce` connect `ce` to `three.min.js`, `.length`, `.fromBufferAttribute`, `.multiplyScalar`, `.constructor`, `.subVectors`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `ze` connect `ze` to `three.min.js`, `Be`, `ve`, `applyMatrix4`, `.length`, `fn`, `.fromArray`, `gi`, `.fromBufferAttribute`, `.multiplyScalar`, `.constructor`, `.subVectors`, `n`, `copy`?**
