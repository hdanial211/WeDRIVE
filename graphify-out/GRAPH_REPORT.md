...
## Corpus Check
- 143 files · ~21,180,510 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3183 nodes · 5760 edges · 214 communities (144 shown, 70 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 294 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `40158008`
...
## Communities (214 total, 70 thin omitted)
...
### Community 12 - "dc"
Cohesion: 0.06
Nodes (13): ac(), cc(), dc(), ic(), jl(), lc(), oc(), rc() (+5 more)
...
### Community 16 - "clone"
Cohesion: 0.12
Nodes (10): T(), clone(), S(), rr, Ua(), b(), S(), T() (+2 more)
...
Cohesion: 0.16
Nodes (23): m(), v(), constructor(), a(), ji(), o(), me(), a() (+15 more)
...
Cohesion: 0.08
Nodes (14): ei, _s(), setSize(), setUsage(), setValue(), Tu(), Bt(), Gt() (+6 more)
...
Cohesion: 0.09
Nodes (3): distanceToPoint(), lr, setDirection()

### Community 33 - "dispose"
Cohesion: 0.10
Nodes (15): de(), dispose(), Hr(), i(), c(), qr(), C(), i() (+7 more)
...
### Community 50 - "na"
Cohesion: 0.05
Nodes (35): An, at(), s(), B(), F(), G(), H(), O() (+27 more)
...
### Community 71 - ".dot"
Cohesion: 0.14
Nodes (4): closestPointToPoint(), closestPointToPointParameter(), delta(), te()
...
### Community 89 - "add"
Cohesion: 0.09
Nodes (5): add(), on, setFromCamera(), setFromCenterAndSize(), setLength()
...
Cohesion: 0.07
Nodes (6): br(), c(), gl, setColors(), translate(), vo
...
Cohesion: 0.10
Nodes (5): al(), applyMatrix4(), ur, Yt(), Xi

### Community 166 - "i"
Cohesion: 0.19
Nodes (12): t(), r(), ea(), i(), a(), c(), l(), o() (+4 more)
...
### Community 184 - "copy"
Cohesion: 0.04
Nodes (15): copy(), hc(), ih, ka(), i(), ko, _l(), li (+7 more)
...
Cohesion: 0.06
Nodes (9): Do, fh, Ga, r(), _i, Oh, ph, toJSON() (+1 more)
...
## Knowledge Gaps
- **621 isolated node(s):** `PREVIEW_I18N`, `allCars`, `allBookings`, `allCars`, `CAL_DATA` (+616 more)
...
- **Why does `ce` connect `ce` to `three.min.js`, `.dot`, `.toJSON`, `ae`, `.multiplyScalar`, `add`, `.normalize`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `copy()` connect `copy` to `three.min.js`, `ve`, `ai`, `.fromJSON`, `dc`, `dr`, `clone`, `sl`, `constructor`, `tr`, `hu`, `.constructor`, `cl`, `.normalize`, `fn`, `dispose`, `applyMatrix4`, `vl`, `gi`, `.constructor`, `ie`, `na`, `isEmpty`, `.multiplyScalar`, `.setAttribute`, `ll`, `bc`, `.updateWorldMatrix`, `Ro`, `clampPoint`, `.updateMatrix`, `Ml`, `Il`, `.dot`, `Nl`, `toJSON`, `wc`, `kc`, `Za`, `updateMatrixWorld`, `add`, `.fromArray`, `fa`, `ec`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `ai` connect `ai` to `three.min.js`, `dispose`, `applyMatrix4`, `i`, `ze`, `.constructor`, `clone`, `isEmpty`, `.multiplyScalar`, `copy`, `.setAttribute`, `add`, `updateMatrixWorld`, `.fromBufferAttribute`, `.fromArray`?**
