# Graph Report - AI CAR RENTAL SYSTEM  (2026-09-01)

## Corpus Check
- 91 files · ~20,803,986 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2590 nodes · 5083 edges · 163 communities (101 shown, 62 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 286 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5d23284d`
...
5. `ce` - 57 edges
6. `Ue` - 51 edges
7. `🚗 WeDRIVE: Ringkasan Penuh Pembangunan Sistem (FYP 1 hingga FYP 2)` - 51 edges
8. `Be` - 38 edges
9. `ve()` - 37 edges
10. `uu` - 35 edges
...
### Community 3 - "na"
Cohesion: 0.06
Nodes (34): An, s(), B(), G(), H(), O(), z(), da() (+26 more)
...
### Community 15 - "clone"
Cohesion: 0.09
Nodes (13): T(), clone(), jr(), mr, a(), qr(), rr, Ua() (+5 more)
...
Cohesion: 0.19
Nodes (4): add(), closestPointToPoint(), ra(), setFromCenterAndSize()

### Community 23 - "ih"
Cohesion: 0.10
Nodes (4): br(), c(), ih, setColors()
...
### Community 31 - "applyMatrix4"
Cohesion: 0.11
Nodes (6): al(), applyMatrix4(), setFromCamera(), vo, Yt(), Xi

### Community 33 - "dispose"
Cohesion: 0.14
Nodes (9): de(), dispose(), i(), C(), i(), Vr(), a(), o() (+1 more)

### Community 34 - "n"
Cohesion: 0.19
Nodes (5): n(), Qn, te(), toShapes(), e()
...
### Community 62 - "xr"
Cohesion: 0.15
Nodes (10): getParameter(), v(), x(), y(), Sr(), Wa(), h(), l() (+2 more)
...
### Community 94 - "copy"
Cohesion: 0.07
Nodes (13): bc, copy(), ec(), fo(), Il, ka(), i(), mh (+5 more)
...
## Knowledge Gaps
- **278 isolated node(s):** `allBookings`, `allCars`, `CAL_DATA`, `CAL_FILTERS`, `allBookings` (+273 more)
...
- **Why does `gn` connect `gn` to `three.min.js`, `.updateMatrix`, `.constructor`, `constructor`, `.fromArray`, `Uo`, `.fromJSON`, `.constructor`, `updateMatrixWorld`, `.length`, `toJSON`, `he`, `.dot`, `remove`, `applyMatrix4`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `copy()` connect `copy` to `three.min.js`, `na`, `ve`, `Be`, `Ga`, `ph`, `ai`, `kc`, `dc`, `gl`, `Oh`, `clone`, `toJSON`, `ul`, `Za`, `he`, `.setValues`, `.multiplyScalar`, `ih`, `tr`, `gi`, `dr`, `applyMatrix4`, `.normalize`, `dispose`, `n`, `constructor`, `lr`, `.fromJSON`, `.constructor`, `on`, `updateMatrixWorld`, `cl`, `.dot`, `ll`, `Ml`, `El`, `xr`, `.updateMatrix`, `.constructor`, `.fromArray`, `Uo`, `vl`, `ie`, `Ro`, `equals`, `fa`, `tl`, `Do`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `ai` connect `ai` to `three.min.js`, `.normalize`, `n`, `.constructor`, `updateMatrixWorld`, `clone`, `.multiplyScalar`, `.applyQuaternion`, `.fromBufferAttribute`, `copy`, `applyMatrix4`?**
