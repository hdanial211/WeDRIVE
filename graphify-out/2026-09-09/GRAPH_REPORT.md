...
## Corpus Check
- 134 files · ~21,139,508 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3078 nodes · 5593 edges · 213 communities (140 shown, 73 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 292 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9ec96503`
...
## Communities (213 total, 73 thin omitted)

### Community 0 - "three.min.js"
Cohesion: 0.02
Nodes (23): bs(), Co, getAverageFrequency(), getFrequencyData(), hl, _initMemoryManager(), jr(), kr() (+15 more)
...
### Community 15 - "dr"
Cohesion: 0.09
Nodes (17): s(), B(), F(), G(), H(), O(), z(), dr() (+9 more)
...
Cohesion: 0.17
Nodes (28): m(), v(), t(), constructor(), a(), i(), ji(), a() (+20 more)
...
### Community 32 - ".dot"
Cohesion: 0.08
Nodes (6): at(), closestPointToPointParameter(), delta(), fn, nn(), te()
...
### Community 41 - ".fromArray"
Cohesion: 0.17
Nodes (11): bindSkeletons(), gl, parse(), parseAnimations(), parseAsync(), parseGeometries(), parseMaterials(), parseObject() (+3 more)
...
Cohesion: 0.12
Nodes (15): 1. Prinsip Pengabadian Maklum Balas Pengguna (Eternal User Mandate Principle), 2. Prinsip Dwikeadaan Draf Bertukar (Interactive Swapping Draft State Protocol), 3. Prinsip Sifar Pemotongan Teks & Sifar Elipsis Butang (Zero Ellipsis & Compact Microcopy Rule), 4. Prinsip Pemisahan Maksud Label & Butang (Label vs Action Distinction Rule), 5. Penyeragaman Istilah Moden: "Harga" Menggantikan "Tarif", 6. Penjanaan Serentak 6 Sudut Foto Pemeriksaan Kenderaan, 7. Keseimbangan Ketinggian Menegak Komponen (Equal Height Alignment 46px), 8. Had Kandungan Fail & Kawalan Siling 12,000 Aksara (+7 more)
...
### Community 62 - "update"
Cohesion: 0.17
Nodes (8): mr, x(), y(), rr, S(), update(), xr(), y()
...
Cohesion: 0.07
Nodes (9): al(), applyMatrix4(), br(), c(), closestPointToPoint(), setColors(), translate(), vo (+1 more)
...
### Community 110 - "_deactivateAction"
Cohesion: 0.23
...
### Community 157 - "n"
Cohesion: 0.29
Nodes (5): Gr(), c(), n(), toShapes(), e()

### Community 167 - ".setHSL"
Cohesion: 0.29
Nodes (3): ee(), ne(), si()
...
Cohesion: 0.40
Nodes (5): [MINOR UPDATE] v6.10.0 — Penginstitusian Fail Peraturan Baharu 22: Undang-undang Emas Maklum Balas Pengguna (New Rule 22: User Feedback Golden Rules Codification), [MINOR UPDATE] v6.9.8 — Penggantian Status Draf Interaktif Swapping, Pemudahan Teks & Populasi Automatik 6 Sudut Foto AI (Interactive Swapping Draft State, Copy Simplification & Auto 6-Photo AI Population), ⚡ [PATCH UPDATE] 221. Pembersihan Mutlak Istilah Teknikal (Sifar Cache/Database/JPJ/Aset), Butang Skrin Penuh 1:1, Palang Kemajuan Dinamik & Animasi Siri Spesifikasi Pintar (v6.9.7), [PATCH] v6.9.10 — Pemadatan Teks Butang AI Spesifikasi Mengelakkan Pemotongan Elipsis (AI Button Microcopy Compacting - Zero Ellipsis Rule), [PATCH] v6.9.9 — Pemisahan Teks Label & Tindakan Butang AI Spesifikasi (AI Spec Label & Button Action Distinct Phrasing)
...
## Knowledge Gaps
- **597 isolated node(s):** `allCars`, `allBookings`, `allCars`, `CAL_DATA`, `CAL_FILTERS` (+592 more)
...
- **Why does `en()` connect `anime.min.js` to `.dot`, `n`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `Ue` connect `Ue` to `three.min.js`, `.fromBufferAttribute`, `add`, `.multiplyScalar`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `gn` connect `gn` to `three.min.js`, `.dot`, `.updateMatrix`, `.fromArray`, `toJSON`, `.constructor`, `add`, `remove`, `constructor`, `.multiplyScalar`, `updateMatrixWorld`, `he`, `.constructor`, `applyMatrix4`?**
