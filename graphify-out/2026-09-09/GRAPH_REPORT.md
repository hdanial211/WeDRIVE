...
## Corpus Check
- 133 files · ~21,138,348 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3061 nodes · 5576 edges · 197 communities (140 shown, 57 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 292 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `674ab113`
...
### Community 11 - "i"
Cohesion: 0.13
Nodes (23): t(), r(), ea(), i(), hh, ji(), load(), a() (+15 more)
...
### Community 16 - "clone"
Cohesion: 0.11
Nodes (10): T(), A(), clone(), a(), Ua(), b(), T(), E() (+2 more)
...
Cohesion: 0.12
Nodes (23): m(), v(), constructor(), a(), mr, y(), s(), h() (+15 more)
...
Cohesion: 0.08
Nodes (20): de(), dispose(), Hr(), i(), S(), qr(), C(), se() (+12 more)
...
### Community 32 - "add"
Cohesion: 0.08
Nodes (9): add(), al(), closestPointToPoint(), closestPointToPointParameter(), delta(), fo(), mo, setFromCenterAndSize() (+1 more)

### Community 33 - ".fromArray"
Cohesion: 0.11
Nodes (3): dh, translate(), vo
...
### Community 71 - "makeEmpty"
Cohesion: 0.16
Nodes (6): expandByPoint(), expandByScalar(), intersect(), makeEmpty(), setFromPoints(), union()
...
### Community 168 - "copy"
Cohesion: 0.08
Nodes (10): bc, copy(), ec(), Il, ka(), i(), li, Nl (+2 more)
...
### Community 179 - "ra"
Cohesion: 0.13
Nodes (4): mh, ra(), setFromCamera(), wh
...
Cohesion: 0.50
Nodes (4): [MINOR UPDATE] v6.9.8 — Penggantian Status Draf Interaktif Swapping, Pemudahan Teks & Populasi Automatik 6 Sudut Foto AI (Interactive Swapping Draft State, Copy Simplification & Auto 6-Photo AI Population), ⚡ [PATCH UPDATE] 221. Pembersihan Mutlak Istilah Teknikal (Sifar Cache/Database/JPJ/Aset), Butang Skrin Penuh 1:1, Palang Kemajuan Dinamik & Animasi Siri Spesifikasi Pintar (v6.9.7), [PATCH] v6.9.10 — Pemadatan Teks Butang AI Spesifikasi Mengelakkan Pemotongan Elipsis (AI Button Microcopy Compacting - Zero Ellipsis Rule), [PATCH] v6.9.9 — Pemisahan Teks Label & Tindakan Butang AI Spesifikasi (AI Spec Label & Button Action Distinct Phrasing)
...
### Community 214 - ".test"
Cohesion: 0.12
Nodes (6): fe(), ge(), v(), Vh, xa(), Ft()

## Knowledge Gaps
- **588 isolated node(s):** `allCars`, `allBookings`, `allCars`, `CAL_DATA`, `CAL_FILTERS` (+583 more)
...
- **Why does `en()` connect `anime.min.js` to `updateMatrixWorld`, `i`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `Ue` connect `Ue` to `three.min.js`, `.fromBufferAttribute`, `.multiplyScalar`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `gn` connect `gn` to `three.min.js`, `.fromArray`, `add`, `.updateMatrix`, `.fromJSON`, `i`, `toJSON`, `.constructor`, `clone`, `ra`, `he`, `.invert`, `constructor`, `.multiplyScalar`, `updateMatrixWorld`, `.constructor`?**
